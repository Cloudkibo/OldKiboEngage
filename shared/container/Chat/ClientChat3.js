...
import ClientChatView3 from './ClientChatView3';
import {printlogs} from '../../services/clientlogging';

class ClientChat3 extends Component {
                    ...
                    <table className="table">
                      ...
                      <tr>
                        <td className="col-md-6">
                          <ClientChatView3 socket={this.props.route.socket}/>
                        </td>
                      </tr>
                      </tbody>
                    </table>
...
export default connect(mapStateToProps, {showAllChat, getcompanylogo})(ClientChat3);
