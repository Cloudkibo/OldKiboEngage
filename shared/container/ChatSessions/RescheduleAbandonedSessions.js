...
class RescheduleAbandonedSessions extends Component {
  ...
  componentWillReceiveProps(props) {
    if (props.companysettings) {
      this.setState({
        emailtemp: props.companysettings.abandonedscheduleemail1,
  ...
  handleSubmit(e) {
    ...
    this.props.updatereschedule({
      'is_rescheduled': 'true',
      'rescheduled_by': this.props.userdetails._id,
      'companyid': this.props.userdetails.uniqueid,
      'request_id': this.props.params.id,
      'usertoken': usertoken,
    }, {emailMsg, usertoken}, '/abandonedchatsessions');
                ...
                <div className="portlet-body">
                  {
                    ...
                    <div>
                      ...
                      <textarea className="form-control" rows="5" ref="emailtemp" onChange={this.onChange.bind(this)}
                                defaultValue={this.props.companysettings.abandonedscheduleemail1}>
