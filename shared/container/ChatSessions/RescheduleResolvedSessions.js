...
import {submitemail, getcompanysettings, getcustomers, getresolvedsessionsfromsocket} from '../../redux/actions/actions'
import {bindActionCreators} from 'redux';
import {browserHistory} from 'react-router'

class RescheduleResolvedSessions extends Component {
  ...
  componentWillReceiveProps(props) {
    if (props.companysettings) {
      this.setState({
        emailtemp: props.companysettings.completedscheduleemail1,
        url: 'http://kiboengage.cloudapp.net/livehelp/' + props.userdetails.uniqueid + '/' + document.title + '/' + props.params.id
      });
    }
  }
  ...
  handleSubmit(e) {
    ...
    var emailMsg = {
      'to': this.props.params.name,
      'emailAdd': this.props.params.email,
      'subject': 'Rescheduling Chat Session',
      'body': this.state.emailtemp,
      'from': this.props.userdetails.firstname + ' ' + this.props.userdetails.lastname,
      'url': this.state.url
    }
    this.props.submitemail({emailMsg, usertoken}, '/resolvedchatsessions');
                ...
                <div className="portlet-body">
                  {
                    ...
                    <div>
                      ...
                      <textarea className="form-control" rows="5" ref="emailtemp" onChange={this.onChange.bind(this)}
                                defaultValue={this.props.companysettings.completedscheduleemail1}>
...
RescheduleResolvedSessions.propTypes = {
...
export default connect(mapStateToProps, {getcompanysettings, submitemail})(RescheduleResolvedSessions);
