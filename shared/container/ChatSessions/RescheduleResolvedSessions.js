...
class RescheduleResolvedSessions extends Component {
 ...
 componentWillReceiveProps(props) {
    if(props.companysettings){
      this.setState({emailtemp: props.companysettings.completedscheduleemail1,url:'http://kiboengage.cloudapp.net/livehelp/'+ props.userdetails.uniqueid+'/'+ document.title+'/'+props.params.id});
    }
}
 onChange(event) {
          ...
          <div className="page-content-wrapper">
           ...
           <div className="portlet-body">
           {
            this.props.companysettings &&
              ...
              <textarea className ="form-control" rows="5" ref = "emailtemp" onChange={this.onChange.bind(this)} defaultValue= {this.props.companysettings.completedscheduleemail1}>
