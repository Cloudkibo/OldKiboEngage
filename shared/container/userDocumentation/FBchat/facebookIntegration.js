     ...
     <div className="page-content-wrapper">
            <div className="page-content">
              ...
              <ul className="uk-breadcrumb">
                ...
                <li>
                  <Link to="/userDocumentation/FBchat/facebookIntegration">FacebookIntegration</Link>
                </li>
              </ul>
              <div className="uk-card uk-card-body uk-card-default">
                ...
                <div className="portlet-body">
                  ...
                  <br /><br />
                  <ol  ref={node => node && node.setAttribute('uk-accordion', 'multiple: true')}>
                      <li className="uk-open">
                          <h3 className="uk-accordion-title" style={{background: '#2ecc71', color: 'white', padding: 5}}>1. Setting up a Facebook App and Page</h3>
                      ...
                      <li className="uk-open">
                          <h3 className="uk-accordion-title" style={{background: '#2ecc71', color: 'white', padding: 5}}>2. Configuring KiboEngage Webhook in the Facebook App</h3>
                          <div className="uk-accordion-content">
                             <ul>
                      ...
                      <li className="uk-open">
                          <h3 className="uk-accordion-title" style={{background: '#2ecc71', color: 'white', padding: 5}}>3. Add Facebook Page Information in KiboEngage Dashboard</h3>
                          <div className="uk-accordion-content">
                              <ul>
                      ...
                      <li className="uk-open">
                          <h3 className="uk-accordion-title" style={{background: '#2ecc71', color: 'white', padding: 5}}>4. Testing Facebook Chat</h3>
                          <div className="uk-accordion-content">
                              <ul>
...
export default connect(mapStateToProps)(facebookIntegration);
