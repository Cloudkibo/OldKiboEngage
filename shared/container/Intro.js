            ...
            <div className="row">
              <div className="col-md-6 col-sm-6 additional-shop-info">
                <ul className="list-unstyled list-inline">
                  ...
                  <li>
                    <button onClick={this.handleClick}> Live Help</button>
                  </li>
                  <li>
              ...
              <ul id="revolutionul">
                ...
                <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400"
                  ...
                  <div className="caption lft slide_desc slide_item_left"
                       ...
                       data-start="2500"
                       data-easing="easeOutExpo">
                    Reach more customers by easily managing multiple Kibosupport communication features<br/> Make teams
                    to reach diversity of customer questions
                  </div>
                ...
                <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400"
                  ...
                  <a className="caption lft slide_btn btn red slide_item_left"
          ...
          <div className="container">
            ...
            <div className="row service-box margin-bottom-40">
              <div className="col-md-4 col-sm-4">
                ...
                <p>A well-designed customer service system for dealing with incoming call requests from any web
                  page.</p>
              </div>
              <div className="col-md-4 col-sm-4">
                <div className="service-box-heading">
                ...
                <p>View reports on performance by agents and teams, agent response time, call statistic, team traffic to
                  get the insights.</p>
              </div>
              <div className="col-md-4 col-sm-4">
                <div className="service-box-heading">
