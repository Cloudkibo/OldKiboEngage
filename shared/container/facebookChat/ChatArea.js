...
export class ChatArea extends Component {
  ...
  startcall(){
    if(confirm('Are you sure you want to start a call with customer?')){
      ...
      var meetingURLStringToSend = 'https://api.cloudkibo.com/#/conference/'+ unique_id +'?role=visitor&type=facebook&companyid='+this.props.userdetails.uniqueid+'&agentemail='+this.props.userdetails.email+'&agentname='+this.props.userdetails.firstname+'&visitorname='+this.props.fbsessionSelected.user_id.first_name+'&visitoremail='+this.props.fbsessionSelected.user_id.email+'&request_id='+this.props.fbsessionSelected.user_id.user_id+''+this.props.fbsessionSelected.pageid.pageid;
      ...
      var meetingURLString = 'https://api.cloudkibo.com/#/conference/'+ unique_id +'?role=agent&type=facebook&companyid='+this.props.userdetails.uniqueid+'&agentemail='+this.props.userdetails.email+'&agentname='+this.props.userdetails.firstname+'&visitorname='+this.props.fbsessionSelected.user_id.first_name+'&visitoremail='+this.props.fbsessionSelected.user_id.email+'&request_id='+this.props.fbsessionSelected.user_id.user_id+''+this.props.fbsessionSelected.pageid.pageid;
