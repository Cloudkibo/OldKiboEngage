...
### Reports
Bring focus on work performed by agents and teams, agent response time, call statistic, group traffic to get the insights. Analytics plays a huge role in customer service. Quality reports helps you to stay on target.
...
Visitor can click the widget button and fill the form and ask question from any relevant team. For example: Sales team, Marketing team.
...
Admin can give rights to supervisor to remove an agent from team and to assign an agent to team
...
When new visitor joins via widget,and agent picks or assign chat session to another agent, it can be seen in the assigned session list by Admin and Agent and Supervisor of the relevant team the visitor has tried to connect to. 
